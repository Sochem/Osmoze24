...
const EventsPage = () => {
  return (
    <div>
      ...
      {/* Background Image */}
      <div className="border border-gray-300 rounded-2xl grid-place-items-center p-6 lg:p-0 sm:m-auto h-20 w-200">
        <div className="bg-red-600 bg-[url(/bgImg.png)] bg-cover min-h-screen grid place-items-center">

          {/* Header */}
          <Image
          className="rounded-full inline-block w-8/12 mt-12 lg:w-2/12"
          src="/src/app/image/Announce.png"
          width={400}
          height={115}
          alt='events'
          />
